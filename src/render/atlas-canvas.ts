 ...
 * isso. Sem esperar aqui, o primeiro atlas mede com a fonte de fallback e
 * fica assim para sempre: o atlas só é refeito se a célula mudar de tamanho,
 * nunca porque uma fonte terminou de carregar.
 */
 ...
 *
 * Com 256 glifos o atlas tem dezesseis fileiras, então a célula multiplica
 * por 32 na altura da textura. Sessenta e quatro dá 1024x2048, dentro do
 * limite de qualquer GPU que rode WebGL2 ou WebGPU, e a célula só chegaria
 * perto disso numa janela de doze mil pixels de largura.
 */
const MAX_CELL = 64;
 ...
 * dois: textura NPOT com filtro `nearest` e `clamp` não perde nitidez. Com o
 * atlas maior que a célula, `nearest` minifica descartando texels e os traços
 * finos saem irregulares — 1:1 é o que mantém o glifo inteiro.
 */
 ...
 *
 * A moldura tem que emendar entre células vizinhas, então o traço vai de
 * borda a borda e o miolo é o cruzamento. Centralizar pela espessura, e não
 * pela metade exata, é o que faz `┌` e `└` alinharem a mesma coluna vertical.
 */
